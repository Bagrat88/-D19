...
class Reviews(models.Model):
    ...
    declaration = models.ForeignKey(Declaration, verbose_name='обявление', related_name='review_declaration', on_delete=models.CASCADE, null=True)
