...
class RegisterUser(UserCreationForm):
    ...
    username = forms.CharField(label='Ник', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ник'}))
    ...
    password1 = forms.CharField(label='Пароль', widget=forms.PasswordInput(attrs={'class': 'form0control', 'placeholder': 'Введите пароль'}))
